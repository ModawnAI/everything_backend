/**
 * Admin Financial Points Test
 * Tests: GET /api/admin/financial/points/overview
 */
...
async function runTest() {
  ...
  // Test financial points overview
  const res = await fetch(`${BASE_URL}/api/admin/financial/points/overview`, {
