-- =============================================
-- FIX SCHEMA SECURITY ISSUES - SIMPLE VERSION
-- =============================================
-- This script fixes security issues by adding SET search_path to existing functions
-- Compatible with combined_schema_all_62.sql
-- =============================================
...
BEGIN
    ...
    FROM reservations r
    JOIN shop_services s ON r.service_id = s.id
...
CREATE INDEX IF NOT EXISTS idx_feed_posts_user_status ON feed_posts(user_id, status);
...
-- ✅ All function search_path mutable issues
